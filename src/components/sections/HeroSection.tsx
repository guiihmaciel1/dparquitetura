  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-muted">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <svg className="absolute top-20 left-10 w-32 h-32 text-accent/15" viewBox="0 0 120 120" fill="none" stroke="currentColor" strokeWidth="0.7">
        ...
        <svg className="absolute bottom-32 right-16 w-40 h-40 text-accent/15" viewBox="0 0 140 140" fill="none" stroke="currentColor" strokeWidth="0.7">
        ...
        <svg className="absolute top-1/3 right-20 w-24 h-24 text-border" viewBox="0 0 120 120" fill="none" stroke="currentColor" strokeWidth="0.7">
        ...
        <svg className="absolute bottom-40 left-20 w-28 h-28 text-border" viewBox="0 0 120 120" fill="none" stroke="currentColor" strokeWidth="0.7">
      ...
      <div className="relative z-10 w-full px-6 flex flex-col items-center justify-center">
        <div className="max-w-4xl w-full text-center">
          ...
          <motion.h1
            ...
            className="font-serif text-4xl md:text-6xl lg:text-7xl xl:text-8xl font-medium leading-[1.1] mb-8 text-foreground"
          >
            Conectando{" "}
            <span className="relative">
              ...
              <motion.span
                ...
                className="absolute bottom-2 left-0 h-3 md:h-4 bg-primary/30 -z-0"
              />
            </span>
            ,<br />
            Função e{" "}
            <span className="italic text-primary">Identidade</span>
          </motion.h1>
          ...
          >
            <span className="inline-flex items-center gap-2 px-5 py-2.5 bg-white/80 backdrop-blur-sm text-muted-foreground text-xs tracking-[0.2em] uppercase rounded-full border border-border">
          ...
          >
            <Link
              href="/projetos"
              className="group inline-flex items-center gap-2 px-8 py-4 bg-primary text-white text-sm tracking-wide hover:bg-accent-dark transition-all duration-300"
            >
              Ver Projetos
            ...
            <Link
              href="/contato"
              className="group inline-flex items-center gap-2 px-8 py-4 border border-foreground/20 text-foreground text-sm tracking-wide hover:border-primary hover:text-primary transition-all duration-300"
            >
              Iniciar Conversa
              <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
            </Link>
